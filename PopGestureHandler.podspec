#
#  Be sure to run `pod spec lint PopGestureHandler.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "划落永恒" => "384457414@qq.com" }
  # Or just: spec.author    = "划落永恒"
  # spec.authors            = { "划落永恒" => "384457414@qq.com" }
  # spec.social_media_url   = "https://twitter.com/划落永恒"
  ...
  spec.source       = { :git => "https://github.com/18840851520/PopGestureHandler.git", :tag => "#{spec.version}" }
